...
namespace E.Tool
{
    ...
    public struct IntProperty
    {
        ...
        [SerializeField, Tooltip("自动变动速率(每秒)")] private int autoChangeRate;
    ...
    public struct FloatProperty
    {
        [SerializeField, Tooltip("是否可变动当前值")] private bool changeable;
        [SerializeField, Tooltip("是否可自动变动当前值")] private bool autoChangeable;
        [SerializeField, Tooltip("自动变动速率(每秒)")] private float autoChangeRate;
        [SerializeField, Tooltip("最大值")] private float max;
        [SerializeField, Tooltip("最小值")] private float min;
        [SerializeField, Tooltip("当前值")] private float now;
        ...
        /// <param name="autoChangeable">是否可自动变动当前值</param>
        /// <param name="changeRate">自动变动速率</param>
        public FloatProperty(float max, float now, float min = 0, bool changeable = true, bool autoChangeable = true, float autoChangeRate = 1)
        {
            if (max < min)
            {
                Debug.LogError("最大值不能小于最小值，已自动交换两个数值");
